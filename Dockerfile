...
ARG NEXT_PUBLIC_SANDBOX_UPLOADED_FILES_DIR
ARG FEATURE_FLAGS
...
# Cloud Sandbox uploaded files directory (e.g. /home/user/data for agent-sandbox)
ENV NEXT_PUBLIC_SANDBOX_UPLOADED_FILES_DIR="${NEXT_PUBLIC_SANDBOX_UPLOADED_FILES_DIR}"
...
ENV APP_URL="" \
    ...
    FEATURE_FLAGS="" \
    PROXY_URL="" \
    LOBE_AUTO_APPROVE_SANDBOX_COMMANDS=""
